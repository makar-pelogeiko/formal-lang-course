...
class GQLTreeVisitor(grammarGQLVisitor):
    def __init__(self, outputter: ObserverOtput):
    ...
    def visitSetVal(self, ctx: grammarGQLParser.SetValContext):
        try:
    ...
    def visitStar(self, ctx: grammarGQLParser.StarContext):
        try:
    ...
    def visitGet_reachable(self, ctx: grammarGQLParser.Get_reachableContext):
        act = "get_reachable"
        flag = True
    ...
    def visitGet_vertices(self, ctx: grammarGQLParser.Get_verticesContext):
        act = "get_vertices"
        flag = True
    ...
    def visitGet_edges(self, ctx: grammarGQLParser.Get_edgesContext):
        act = "get_edges"
        flag = True
    ...
    def visitGet_labels(self, ctx: grammarGQLParser.Get_labelsContext):
        act = "get_labels"
        flag = True
    ...
    def visitMapsys(self, ctx: grammarGQLParser.MapsysContext):
        flag = True
    ...
    def visitFiltersys(self, ctx: grammarGQLParser.FiltersysContext):
        flag = True
    ...
    def visitLoad(self, ctx: grammarGQLParser.LoadContext):
